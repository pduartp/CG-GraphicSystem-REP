...
if __name__ == '__main__':
    ...
    with open("saida.xml", "w") as arquivo:
        ...
        for ponto in poligono.pontos:
            arquivo.write(
                (
                    (
                        "        <ponto x=\""
                        + str(int(ponto.x) - margem_x)
                        + "\" y=\""
                        + str(int(ponto.y) - margem_y)
                    )
                    + "\"/>\n"
                )
            )
